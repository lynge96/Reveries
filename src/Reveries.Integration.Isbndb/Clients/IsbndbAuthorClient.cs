...
public class IsbndbAuthorClient : ExternalBaseClient<IsbndbAuthorClient>, IIsbndbAuthorClient
{
    ...
    public async Task<AuthorSearchResponseDto?> SearchAuthorsByNameAsync(Author author, CancellationToken ct)
    {
    ...
    public async Task<AuthorBooksResponseDto?> FetchBooksByAuthorAsync(Author author, CancellationToken ct)
    {
