...
public interface IGoogleBookSearch
{
    ...
    /// </summary>
    /// <param name="isbns">A collection of ISBNs (10 or 13 digits) to look up.</param>
    /// <param name="ct">A token that can be used to cancel the request.</param>
    /// <returns>A list of <see cref="Book"/> entities corresponding to the provided ISBNs. If none are found, an empty list is returned.</returns>
    ...
    Task<List<Book>?> GetBooksByTitlesAsync(IReadOnlyList<string> titles, CancellationToken ct = default);
}