...
public interface IBookLookupService
{
    ...
    Task<List<Book>> FindBooksByTitleAsync(List<string> titles, CancellationToken ct = default);
    ...
    Task<List<Book>> FindBooksByAuthorAsync(string author, CancellationToken ct = default);
    ...
    Task<List<Book>> FindBooksByPublisherAsync(string publisher, CancellationToken ct = default);
    
    Task<List<Book>> GetAllBooksAsync(CancellationToken ct = default);
    
    Task<Book?> FindBookById(int id, CancellationToken ct = default);
